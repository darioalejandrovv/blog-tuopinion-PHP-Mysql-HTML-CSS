...
<html>
<head>
	<title>Agregar post - TU OPINION</title>
...
<body>
  ...
  <a href="add-post.php">Agregar post</a>
	...
	<div class="container">
		...
		<div class="right"><br>
			...
			<div class="publishbox">
				...
				<br><br>
				<label class="we">Estatus: Borrador</label><br><br>
